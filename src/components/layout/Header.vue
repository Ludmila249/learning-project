    ...
    <div class="header__top-wrap">
      ...
      >
        <button 
          ...
          type="button" 
          ref="button"
          @click="handlerClick('open-mobile', 'button')"
        >
...
export default {
  ...
  methods: {
    ...
    handlerClick(className, ref) {
      if(this.$refs[ref].classList.contains(className)) {
        this.$refs[ref].classList.remove(className);
        if(className === 'open-mobile') {
          this.$refs.active.classList.remove("active");
        }
      } else {
        this.$refs[ref].classList.add(className);
        if(className === 'open-mobile') {
